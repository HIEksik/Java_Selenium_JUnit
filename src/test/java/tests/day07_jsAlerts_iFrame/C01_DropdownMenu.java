...
public class C01_DropdownMenu extends TestBase {
    ...
    public void zeroAppTesti(){
        ...
        WebElement currenDdm= driver.findElement(By.id("pc_currency"));
        Select select = new Select(currenDdm);
        ...
        WebElement usDollarsRadio=driver.findElement(By.id("pc_inDollars_true"));
        Assert.assertFalse(usDollarsRadio.isSelected());
        ...
        WebElement foreingYazisi=driver.findElement(By.id("alert_content"));

        String expectedYazi="Foreign currency cash was successfully purchased.";
        String actualYazi=foreingYazisi.getText();
